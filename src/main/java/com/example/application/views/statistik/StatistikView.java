package com.example.application.views.statistik;
...
@Uses(Icon.class)
public class StatistikView extends Div {
    ...
    public StatistikView(SamplePersonService SamplePersonService) {
        this.samplePersonService = SamplePersonService;
        setSizeFull();
        addClassNames("statistik-view");
